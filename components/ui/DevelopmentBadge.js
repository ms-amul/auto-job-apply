...
export default function DevelopmentBadge() {
  ...
  return (
    ...
    >
      {/* Badge */}
      <div className="relative flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-blue-50 to-orange-50 border border-blue-300 rounded-full shadow-lg shadow-blue-200/50 transition-all duration-300 hover:shadow-blue-300/60 hover:border-blue-400 cursor-pointer">
        {/* Animated pulse dot */}
      ...
      {/* Hover tooltip */}
      <div
        className={`absolute top-full right-0 mt-2 w-64 p-4 bg-white border border-gray-200 rounded-xl shadow-2xl transition-all duration-300 ${isHovered
