        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <button
                className="group text-white px-8 py-4 rounded-full text-base font-medium transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
              ...
              <button className="border border-gray-300 text-gray-800 px-8 py-4 rounded-full text-base font-medium hover:border-gray-400 hover:bg-white/60 backdrop-blur-sm transition-all">
                Watch Demo
              </button>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 justify-center lg:justify-start">
              <div className="bg-white border border-gray-200 rounded-lg px-4 py-2 flex items-center gap-2">
                <span className="text-xs font-semibold" style={{ color: theme.accentPrimary }}>🏆 #1 Product of the Day</span>
              </div>
              <div className="bg-white border border-gray-200 rounded-lg px-4 py-2 flex items-center gap-2">
                <span className="text-xs font-semibold" style={{ color: theme.accentPrimary }}>🚀 #3 Product of the Week</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative w-full h-[600px]">
              ...
              <div className="absolute top-8 left-0 bg-white rounded-2xl shadow-xl p-4 max-w-xs animate-float" style={{animationDelay: '0s'}}>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style={{ background: theme.getAccentGradient(135) }}>
              ...
              <div className="absolute top-32 right-0 bg-white rounded-2xl shadow-xl p-4 w-64 animate-float" style={{animationDelay: '0.5s'}}>
                <div className="flex items-start gap-3">
                  <div className="w-12 h-12 rounded-full shrink-0" style={{ background: theme.getAccentGradient(135) }}></div>
                  ...
                  <div className="text-right">
                    <span className="text-xs font-semibold" style={{ color: theme.accentPrimary }}>92% Match</span>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-8 right-8 bg-white rounded-2xl shadow-xl p-4 w-72 animate-float" style={{animationDelay: '1.5s'}}>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0" style={{ background: theme.getAccentGradient(135) }}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      <div className="w-2 h-2 rounded-full animate-pulse" style={{ background: theme.accentPrimary }}></div>
                      <div className="w-2 h-2 rounded-full animate-pulse" style={{ background: theme.accentPrimary, animationDelay: '0.2s' }}></div>
                      <div className="w-2 h-2 rounded-full animate-pulse" style={{ background: theme.accentPrimary, animationDelay: '0.4s' }}></div>
